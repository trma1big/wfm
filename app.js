...
const nm_dependencies = ['pdfmake','datatables.net-buttons','html2canvas','jspdf','filepond','filepond-plugin-file-rename','date-and-time','bpmn-js','bootstrap-icons','bootstrap','jquery','@popperjs','datatables.net-bs5','datatables.net','chart.js']; 
